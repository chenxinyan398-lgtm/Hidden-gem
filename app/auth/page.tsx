  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-6">
      <div className="w-full text-center mb-10 mt-10">
        ...
        <p className="text-zinc-400 text-sm">你的專屬私房景點與秘境清單分享</p>
      </div>
      ...
      <form className="flex-1 flex flex-col w-full gap-4 text-zinc-300">
        ...
        {params?.message && (
          <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm p-3 rounded-lg mt-2 text-center">
            {params.message}
          </div>
        )}
